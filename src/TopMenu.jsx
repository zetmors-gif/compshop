    ...
    <div className="w-full bg-[#050505] text-white overflow-hidden">
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center justify-center text-center px-4 pointer-events-none">
          ...
          >
            {/* BADGE */}
            <div className="bg-red-600 text-black px-6 py-1 font-black text-2xl mb-6 inline-block italic -skew-x-12 tracking-tighter shadow-[0 0 25px rgba(220,38,38,0.5)] border-2 border-black">
              ZETMORS KRD 
            </div>
            ...
            <div className="glitch-wrapper block select-none">
              <h1 
                className="glitch-text text-[15vw] md:text-[12vw] font-black tracking-tighter uppercase italic leading-[0.8] mix-blend-difference"
            ...
            {/* SUBTITLE */}
            <p className="mt-8 text-zinc-400 font-mono tracking-[0.5em] text-[10px] md:text-sm uppercase bg-black/40 backdrop-blur-md py-2 px-6 border border-white/10 rounded-sm">
